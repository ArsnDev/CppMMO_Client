...
public struct Vec3 : IFlatbufferObject
{
  ...
  public static Offset<CppMMO.Protocol.Vec3> CreateVec3(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f,
      float z = 0.0f) {
  ...
  public static Offset<CppMMO.Protocol.Vec3> EndVec3(FlatBufferBuilder builder) {
